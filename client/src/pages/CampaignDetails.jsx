...
const CampaignDetails = () => {
  ...
  // Create an instance of ethers.BigNumber using the hexadecimal value
const goalAmountBigNumber = ethers.BigNumber.from(charityProject.goalAmount);

// Convert the BigNumber to the equivalent amount in ether
    ...
    <div>
      ...
      <div className="w-full flex md:flex-row flex-col mt-10 gap-[30px]">
        <div className="flex-1 flex-col">
          <img src={charityProject.image} alt="campaign" className="w-full h-[410px] object-cover rounded-xl"/>
          <div className="relative w-full h-[5px] bg-[#3a3a43] mt-2">
            <div className="absolute h-full bg-[#4acd8d]" style={{ width: `${calculateBarPercentage(goalAmountEther, currentAmountEther)}%`, maxWidth: '100%'}}>
            </div>
          </div>
        </div>
        ...
        <div className="flex md:w-[150px] w-full flex-wrap justify-between gap-[30px]">
          ...
          <CountBox title={`Raised of ${goalAmountEther}`} value={currentAmountEther} />
          ...
          <div>
            <h4 className="font-epilogue font-semibold text-[18px] text-white uppercase">Story</h4>
              ...
              <div className="mt-[20px]">
                <p className="font-epilogue font-normal text-[16px] text-[#808191] leading-[26px] text-justify">{charityProject.desc}</p>
              </div>
          </div>
